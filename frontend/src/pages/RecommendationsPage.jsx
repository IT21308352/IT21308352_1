  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div className="relative h-screen flex justify-center items-center">
        ...
        />
        <div className="absolute inset-0 bg-black bg-opacity-50" /> {/* Adjusted opacity */}
        <motion.div
      ...
      <div
        ref={sectionRef}
        className="container mx-auto mt-12 p-6 bg-white bg-opacity-90 rounded-lg shadow-lg"
        id="soil-recommendation"
      >
        {/* Soil Recommendations */}
        <section className="mb-16 p-8 bg-green-50 bg-opacity-90 rounded-xl">
          ...
          <div className="space-y-6">
            {soilRecommendations.length > 0 ? (
              soilRecommendations.map((rec, index) => (
                <div
                  key={index}
                  className="p-6 rounded-lg bg-white bg-opacity-90 shadow-md border-l-4 border-green-500"
                >
        ...
        <section className="mb-16 flex flex-col-reverse lg:flex-row items-center gap-10 bg-gray-100 bg-opacity-90 p-10 rounded-xl">
        ...
        <section className="mb-16 lg:flex-row items-center gap-10 bg-gray-100 bg-opacity-90 p-10 rounded-xl">
          <h2 className="text-4xl font-semibold text-green-700 mb-6">
            ...
            Object.keys(districtRecommendations).map(
              (key, index) =>
                key.startsWith("recommendation") && (
                  <div
                    key={index}
                    className="p-6 mb-4 bg-gray-200 bg-opacity-90 rounded-lg shadow-md"
                  >
